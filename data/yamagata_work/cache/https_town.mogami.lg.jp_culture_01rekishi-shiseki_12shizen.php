...
<link rel="stylesheet" type="text/css" href="../../common/css/style-new.css?20260705110401" media="all"/>
<link rel="stylesheet" type="text/css" href="../../common/css/all.css" media="all"/>
<link rel="stylesheet" type="text/css" href="../../common/css/print.css?20260705110401" media="print"/>
<link rel="icon" href="../../favicon.ico">
<link rel="apple-touch-icon" sizes="180x180" href="../../apple-touch-icon.png>">
<title>分水嶺｜最上町役場</title>
</head>
		<body class="culture">
	<!-- Google tag (gtag.js) -->
		...
		<div class="contents">
			...
			<article>
				<section>
					...
					<div class="kiji">
<!---------------- start ------------------->
						<h2 class="page-title">分水嶺</h2>
	<p align="center"><img src="data/shizen/bunsuirei.jpg" alt="分水嶺" width="640" height="480"></p>
	<p>陸羽東線の堺田駅前には、太平洋と日本海へと分かれる「分水嶺」があります。</p>
	<p>東側(宮城県)は江合川、旧北上川を経て１１６Ｋｍを下り、宮城県石巻市の太平洋へ、西は小国川、最上川を経て１０２Ｋｍを下ると山形県酒田市の日本海へ注ぎます。</p>
	<p>	  平坦な場所にある分水嶺は全国的に珍しく、東西の海へと分かれる分岐点を目の前に見ることができます。</p>
	<p align="center"><IMG src="data/bunsuirei/bunsuirei1.jpg" alt="分水嶺説明" width="700"></p>
	<p>すぐそばに、松尾芭蕉が泊まった<A href="../../life/02shisetsu/27houjin-no-ie.php">「封人の家」</A>があります。</p>
	<p class="has-text-danger">※冬季閉鎖（11月～3月まで） トイレは利用できません。</p>
