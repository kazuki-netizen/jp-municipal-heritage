...
<link rel="stylesheet" type="text/css" href="../../common/css/style-new.css?20260705110349" media="all"/>
<link rel="stylesheet" type="text/css" href="../../common/css/all.css" media="all"/>
<link rel="stylesheet" type="text/css" href="../../common/css/print.css?20260705110349" media="print"/>
<link rel="icon" href="../../favicon.ico">
<link rel="apple-touch-icon" sizes="180x180" href="../../apple-touch-icon.png>">
<title>歴史・文化・史跡(瀬見地区)｜最上町役場</title>
</head>
		<body class="culture">
	<!-- Google tag (gtag.js) -->
		...
		<div class="contents">
			...
			<article>
				<section>
					...
					<div class="kiji">
<!---------------- start ------------------->
						<h2 class="page-title">歴史・文化・史跡(瀬見地区)</h2>
	<p> この地域は、義経・弁慶にまつわる史跡が多くあります。</p>
						
	<h4><a name="sandou_" class="ank">亀割峠参道</a></h4>
						
	<p>文治３年兄頼朝に追われた弁慶義経一行が超えたと云われる峠であり、その歴史的ロマンの面影が今も色濃く残ります。</p>
	<p align="center"><img src="data/rekishi-semi/00.jpg" alt="亀割峠参道" width="320" height="221" class="img-center"></p>
						
	<h4><a name="kannon_" class="ank">亀割子安観音</a></h4>
						
<p>義経一行が、奥州平泉に向う途中、北の方が「亀若丸」を出産したといわれています。
  その時義経一行が北の方の安産を祈願した観音様と伝えられています。 </p>
<p align="center"><IMG src="data/rekishi-semi/01.jpg" alt="亀割子安観音" width="260" height="175" class="img-center"></p>
	
<h4> <a name="okunoin_" class="ank">子安観音奥の院</a></h4>
						
	<p>　石碑には「義経北の方御産の跡、文治３年旧４月８日」と刻まれてあります。
	  近くに亀若丸が枕にしたという子枕石、弁慶が手植えした弁慶杉があり今も神秘的な面影を残しています。	</p>
	<p align="center"><IMG src="data/rekishi-semi/02.jpg" alt="子安観音奥の院" width="320" class="img-center"></p>
		
	<h4><a name="yumae_" class="ank">瀬見温泉湯前神社</a></h4>
						
	<p>文治３年に弁慶によって発見された瀬見温泉の守り神で、亀若丸の産湯として使われたといわれています。  毎年九月一日には義経を偲び中尊寺、毛越寺の僧侶による供養祭が行われます。	</p>
	<p align="center" class="ank"><IMG src="data/rekishi-semi/03.jpg" alt="瀬見温泉湯前神社" width="260" height="175">　<IMG src="data/rekishi-semi/04.jpg" alt="供養祭" height="195"></p>
	
	<h4><a name="suzuri_" class="ank">弁慶の硯石</a></h4>
		
	<p> 瀬見発電所へ渡るつり橋のたもとに、大きな平らな岩があります。
  亀若丸の名をつけるとき、この岩を硯のように削って、硯として使い、墨をすったといわれています。</p>
		
	<p align="center" class="ank"><IMG src="data/rekishi-semi/05.jpg" alt="弁慶の硯石" height="222" class="img-center"></p>
		
	<h4><a name="nagematsu_" class="ank">弁慶の投げ松</a></h4>
		
	<p> 瀬見温泉駅から温泉に向かう途中の大きな松を、こう呼んでいます。</p>
<p>弁慶が亀若丸の誕生を祝って、「再び義経公の世になって栄えるように」と、峠頂上から投げた松が、ここに根付いたものだと伝えられています。</p>
