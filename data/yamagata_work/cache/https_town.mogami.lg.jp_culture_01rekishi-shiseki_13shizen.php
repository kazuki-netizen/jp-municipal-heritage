...
<link rel="stylesheet" type="text/css" href="../../common/css/style-new.css?20260705110403" media="all"/>
<link rel="stylesheet" type="text/css" href="../../common/css/all.css" media="all"/>
<link rel="stylesheet" type="text/css" href="../../common/css/print.css?20260705110403" media="print"/>
<link rel="icon" href="../../favicon.ico">
<link rel="apple-touch-icon" sizes="180x180" href="../../apple-touch-icon.png>">
<title>登山口・トレッキング｜最上町役場</title>
</head>
		<body class="culture">
	<!-- Google tag (gtag.js) -->
		...
		<div class="contents">
			...
			<article>
				<section>
					...
					<div class="kiji">
<!---------------- start ------------------->
						<h2 class="page-title">登山口・トレッキング</h2>

    <p align="center"><IMG src="data/shizen/tozan2.jpg" alt="八森山の急峻な山容" width="320" height="240"><br>
      八森山の急峻な山容</p>
...
<table class="table is-bordered is-striped">
	    <TBODY>
	      <TR >
	        <TH>登山口</TH>
	        <TH>行き先</TH>
	        <TH width="70%">コース概要</TH>
	        </TR>
	      <TR>
	        <Td>薬師原口</Td>
	        <Td>八森山</Td>
	        <TD>登り坂が続くややきついコースです。市町境まで90分。その後は眺望が望め、快適な歩きとなります。八森山まで50分。八森山から槍ヶ先に縦走（110分）して親倉見口方面へ下山できます。</TD>
	        </TR>
	      <TR>
	        <Td>親倉見口</Td>
	        <Td>槍ヶ先<br>
	          火打岳</Td>
	        <TD>アカマツの大木を過ぎると登り坂になりますが、平らなところもあり比較的に楽なコースで、山頂へは140分程度です。槍ヶ先から火打岳までは中央、大尺山を経て100分です。</TD>
	      </TR>
	      <TR>
	        <Td>西の又口</Td>
	        <Td>小又山</Td>
	        <TD>赤倉又沢を渡渉して対岸の登山口から登ります。水が少ないときは濡れずに済む場合もあります。1111ピークまで100分は登りがきついところです。その後越途まで40分。ここで大又口のコースと合流します。その後山頂までは60分です。</TD>
	      </TR>
	      <TR>
	        <Td>大又口</Td>
	        <Td>小又山</Td>
	        <TD>渡渉しないで小又山へ行けます。また神室山との周回ができる登山コースです。大又口の上流１００ｍほどに車を停めると、根の崎口からは３００ｍくらいとなります。越途まで180分程度で、3合目くらいまでは急な尾根登りとなります。小又山までは60分程度で登れ、健脚者は天狗森（70分）、神室山（120分）、そして根の崎口（210分）と周回も可能です。</TD>
	        </TR>
	      <TR>
	        <Td>根の崎口</Td>
	        <Td>神室山</Td>
	        <TD>大又口から４００ｍくらい上流の空き地に車を停めます。3合目まではきつい尾根登りですが、6合目からは眺望のいい尾根歩きとなります。神室山までは240分程度でゆっくり行けます。</TD>
	        </TR>
	      <TR>
	        <Td>銚子口</Td>
	        <Td>禿岳</Td>
	        <TD>前森高原を過ぎて車で5分程度で登山口があり、ややきつい登りを150分くらいで禿岳の山頂へ登れます。9合目くらいまではあまり眺望はありません。初級者は鳴子経由で花立峠口から（120分）がオススメです。</TD>
	        </TR>
	      </TBODY>
	  </TABLE>
</div>
