...
PREFS = ["iwate", "miyagi", "aomori", "akita", "yamagata", "fukushima", "hokkaido", "tochigi", "gunma", "ibaraki", "saitama", "chiba", "kanagawa", "tokyo", "niigata", "yamanashi", "toyama", "ishikawa", "fukui", "nagano", "shizuoka", "gifu", "aichi", "mie", "shiga", "kyoto", "osaka", "hyogo", "nara", "wakayama", "tottori", "shimane", "okayama", "hiroshima", "yamaguchi", "tokushima", "kagawa", "ehime", "kochi"]
...
# Generous bounding box (lat N, lon E) — covers Tohoku + Hokkaido + Tochigi + Gunma + Ibaraki.
