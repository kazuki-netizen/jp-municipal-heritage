...
| 香川県 | [`data/kagawa.jsonl`](data/kagawa.jsonl) | 738 | 15 / 17 (さぬき市 via Wayback after TLS expiry; 三木町 designation levels unverifiable; 琴平町 publishes no list) |
| 愛媛県 | [`data/ehime.jsonl`](data/ehime.jsonl) | 1,744 | 18 / 20 (新居浜 76 and 内子 95 exact; 西予市・松野町 aggregate-only sources) |
...
| 福岡県 | [`data/fukuoka.jsonl`](data/fukuoka.jsonl) | 1,227 | 45 / 60 (福岡市 228 via the Board of Education yearbook PDF; 久留米 107 and 宗像 33 exact; 13 towns publish no list) |
| 佐賀県 | [`data/saga.jsonl`](data/saga.jsonl) | 386 | 11 / 20 (唐津市 110 — the older "52" figure was the prefectural column; several municipalities have JS-only or unlabeled sources) |
| 長崎県 | [`data/nagasaki.jsonl`](data/nagasaki.jsonl) | 1,051 | 16 / 21 (12 exact matches incl. 対馬 123 and 壱岐 168; 5 towns publish no list) |
| 熊本県 | [`data/kumamoto.jsonl`](data/kumamoto.jsonl) | 1,817 | 32 / 45 (25 exact matches incl. 八代 197 and 山鹿 160; small Kuma-region villages publish aggregate counts only) |
...
| 鹿児島県 | [`data/kagoshima.jsonl`](data/kagoshima.jsonl) | 1,699 | 37 / 43 (22 exact matches incl. 鹿児島市 91 and 南九州 156; 境港-style partial publications in several towns) |
...
| 香川県 | `data/kagawa.jsonl` | 738 | 15 / 17市町（さぬき市はTLS失効でWayback経由；三木町は区分確認不能；琴平町は一覧非公開） |
| 愛媛県 | `data/ehime.jsonl` | 1,744 | 18 / 20市町（新居浜76・内子95完全一致；西予市・松野町は集計のみ） |
| 高知県 | `data/kochi.jsonl` | 940 | 19 / 34市町村（完全一致4；13小規模町村は一覧非公開；土佐市はWAFで取得不能） |
| 福岡県 | `data/fukuoka.jsonl` | 1,227 | 45 / 60市町村（福岡市228は教育要覧PDFより；久留米107・宗像33完全一致；13町村は一覧非公開） |
| 佐賀県 | `data/saga.jsonl` | 386 | 11 / 20市町（唐津市110＝旧参照値52は県列の誤読；JS型・区分なしソースの自治体が複数） |
| 長崎県 | `data/nagasaki.jsonl` | 1,051 | 16 / 21市町（完全一致12：対馬123・壱岐168等；5町は一覧非公開） |
| 熊本県 | `data/kumamoto.jsonl` | 1,817 | 32 / 45市町村（完全一致25：八代197・山鹿160等；球磨郡の小規模村は集計のみ公開） |
...
| 鹿児島県 | `data/kagoshima.jsonl` | 1,699 | 37 / 43市町村（完全一致22：鹿児島市91・南九州156等） |
