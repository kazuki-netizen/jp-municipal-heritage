...
— 23,638 designations across 457 municipalities (13 prefectures).** The schema is designed to scale nationally
...
| **合計** | [`data/all.geojson`](data/all.geojson) | **23,638** | **457 / 543** |
...
- **23,638 designations total** across thirteen prefectures (Tohoku 6 + Hokkaido + six Kanto prefectures).
...
```bash
python3 site/build_pages.py           # ~23,638 pages under site/p/
```
...
**v10: 東北6県（青森・岩手・宮城・秋田・山形・福島）＋北海道＋関東6県（栃木・群馬・茨城・埼玉・千葉・神奈川）が対象です。計23,638件、457市町村、13都道府県。**
...
| 合計 | `data/all.geojson` | **23,638** | 457 / 543市町村 |
