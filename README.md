...
**v17: NATIONAL COMPLETION — this release adds Kyushu and Okinawa (福岡県・佐賀県・長崎県・熊本県・大分県・宮崎県・鹿児島県・沖縄県), completing all 47 prefectures of Japan
— 78,515 designations across 1,375 municipalities (v17.1 folds in a further 841 gap-fill rows across 10 prefectures and removes 20 superseded/noise rows). This release also folds in gap-fill improvements for 滋賀・大阪・兵庫・奈良・和歌山・岡山 (475 rows; all previously published IDs unchanged).** The schema is designed to scale nationally
(see [`SCHEMA.md`](SCHEMA.md)).

## Coverage at a glance (v17 — all 47 prefectures)
...
| 山梨県 | [`data/yamanashi.jsonl`](data/yamanashi.jsonl) | 1,419 | 21 / 27 (6 municipalities publish no comprehensive list; 笛吹市 135 (recovered after initial publication; the official summary cites 62); 甲斐市 76 exact after recovering the successor PDF of a lost list) |
...
| 石川県 | [`data/ishikawa.jsonl`](data/ishikawa.jsonl) | 2,060 | 19 / 19 (能登町 32 of official 320 recovered via gap-fill — no complete itemized public list exists; 穴水町 4 via museum pages; 12 municipalities match official counts exactly) |
| 福井県 | [`data/fukui.jsonl`](data/fukui.jsonl) | 1,507 | 17 / 17 (all covered; 越前町 113 via 織田文化歴史館; 永平寺町 21 via 町勢要覧) |
| 長野県 | [`data/nagano.jsonl`](data/nagano.jsonl) | 3,541 | 60 / 77 (17 small municipalities publish no comprehensive list; 岡谷市 121 via 教育要覧 PDF; 高森町 4 of official 30 — map-only source) |
...
| 愛知県 | [`data/aichi.jsonl`](data/aichi.jsonl) | 3,397 | 45 / 54 (8 municipalities publish no comprehensive list; 一宮市 245 after removing prefectural-designation rows; 瀬戸市 55 of official 55 (completed via gap-fill); 常滑市 21 of official 145 — the official site publishes representative examples only) |
...
| 滋賀県 | [`data/shiga.jsonl`](data/shiga.jsonl) | 1,536 | 18 / 19 (12 exact official matches incl. 長浜 248 and 東近江 206; 湖南市 honest-zero — official 66 but no itemized public list; 竜王町 publishes no list) |
...
| 大阪府 | [`data/osaka.jsonl`](data/osaka.jsonl) | 1,329 | 36 / 43 (7 municipalities verified as having zero municipal designations via the prefectural fallback PDFs; 八尾市 69 of official 73 (recovered from the external map service via gap-fill)) |
| 兵庫県 | [`data/hyogo.jsonl`](data/hyogo.jsonl) | 2,406 | 38 / 41 (14 exact official matches incl. 神戸 125 and 豊岡 251; 養父市・香美町 itemized lists not reachable; 相生市・稲美町 publish no list) |
| 奈良県 | [`data/nara.jsonl`](data/nara.jsonl) | 742 | 34 / 39 (17 exact official matches; 5 municipalities publish no list; 4 more lack designation-level labels) |
| 和歌山県 | [`data/wakayama.jsonl`](data/wakayama.jsonl) | 754 | 17 / 30 (12 municipalities publish no list; 和歌山市 92 exact; 有田川町 3 of official 144; 海南市 JS-rendered site) |
...
| 岡山県 | [`data/okayama.jsonl`](data/okayama.jsonl) | 1,713 | 20 / 27 (11 exact matches incl. 倉敷 86 and 真庭 202; 津山市 SPA-only site, 吉備中央町 aggregate-only; 久米南町 has no municipal designation system) |
| 広島県 | [`data/hiroshima.jsonl`](data/hiroshima.jsonl) | 1,943 | 21 / 23 (広島市 108 from 13 PDFs; 熊野町 via Wayback after domain expiry; 府中町 verified zero current designations; 大崎上島町 no reachable list) |
...
| 徳島県 | [`data/tokushima.jsonl`](data/tokushima.jsonl) | 670 | 17 / 24 (5 exact matches; 6 municipalities publish no list; 東みよし町 source lacks designation labels) |
| 香川県 | [`data/kagawa.jsonl`](data/kagawa.jsonl) | 799 | 15 / 17 (さぬき市 via Wayback after TLS expiry; 三木町 designation levels unverifiable; 琴平町 publishes no list) |
| 愛媛県 | [`data/ehime.jsonl`](data/ehime.jsonl) | 1,989 | 20 / 20 (新居浜 76 and 内子 95 exact; 西予市・松野町 aggregate-only sources) |
| 高知県 | [`data/kochi.jsonl`](data/kochi.jsonl) | 940 | 19 / 34 (4 exact matches; 13 small municipalities publish no list; 土佐市 blocked by a WAF) |
| 福岡県 | [`data/fukuoka.jsonl`](data/fukuoka.jsonl) | 1,227 | 45 / 60 (福岡市 198 via the Board of Education yearbook PDF (20 superseded rows removed in v17.1); 久留米 107 and 宗像 33 exact; 13 towns publish no list) |
| 佐賀県 | [`data/saga.jsonl`](data/saga.jsonl) | 455 | 14 / 20 (唐津市 110 — the older "52" figure was the prefectural column; several municipalities have JS-only or unlabeled sources) |
| 長崎県 | [`data/nagasaki.jsonl`](data/nagasaki.jsonl) | 1,105 | 21 / 21 (12 exact matches incl. 対馬 123 and 壱岐 168; 5 towns publish no list) |
| 熊本県 | [`data/kumamoto.jsonl`](data/kumamoto.jsonl) | 1,995 | 40 / 45 (25 exact matches incl. 八代 197 and 山鹿 160; small Kuma-region villages publish aggregate counts only) |
| 大分県 | [`data/oita.jsonl`](data/oita.jsonl) | 2,148 | 18 / 18 (all covered; 佐伯 220・宇佐 209 exact; 国東 322 harvested from 71 district pages) |
| 宮崎県 | [`data/miyazaki.jsonl`](data/miyazaki.jsonl) | 631 | 20 / 26 (10 exact matches; 6 municipalities publish no itemized list; 延岡市 5 of official 98 — no public list exists) |
| 鹿児島県 | [`data/kagoshima.jsonl`](data/kagoshima.jsonl) | 1,701 | 37 / 43 (22 exact matches incl. 鹿児島市 91 and 南九州 156; 境港-style partial publications in several towns) |
| 沖縄県 | [`data/okinawa.jsonl`](data/okinawa.jsonl) | 859 | 31 / 41 (10 exact matches incl. うるま 46 and 名護 50; 8 municipalities publish no list; 多良間村 32 of official 70) |
| **合計** | [`data/all.geojson`](data/all.geojson) | **78,515** | **1,375 / 1,741** |
...
| [`data/all.geojson`](data/all.geojson) | Combined geojson across all 47 prefectures. |
...
- **jmh_id**: all rows carry a unique `JMH-XXXXXX-NNNN` identifier; all prior IDs are preserved unchanged (v17 added 10,293 IDs for Kyushu-Okinawa and gap-fills; 0 existing IDs changed).
- **Coverage**: 1,375 municipalities yielded records. Zero-yield municipalities are listed
...
```bash
python3 site/build_pages.py           # ~78,515 pages under site/p/
```
...
## Reproducibility / research use 研究利用と再現性

For analysis that must be reproducible (papers, theses), **pin a tagged release
instead of `main`** — `main` receives ongoing corrections and refresh passes.

- Fixed version: tag **`v17.1`** (2026-07-13; 78,515 rows, 47 prefectures,
  1,375 municipalities; English layer: 20 prefectures / 40,326 rows).
- Canonical data files are `data/<pref>.jsonl` (one per prefecture, with stable
  `jmh_id`). Anything under `data/*_parts/` is a historical collection
  intermediate — do not use it for analysis.
- Integrity: `shasum -a 256 -c docs/checksums-v17.1.txt`
- Pinned raw URL form:
  `https://raw.githubusercontent.com/kazuki-netizen/jp-municipal-heritage/v17.1/data/<pref>.jsonl`

日本語: 論文等で再現性が必要な分析では `main` ではなく**タグ付きリリース
（`v17.1`）を固定して**使ってください。正規データは `data/<都道府県>.jsonl`
（安定IDの `jmh_id` 付き）で、`data/*_parts/` は収集時の中間産物です。
チェックサムは `docs/checksums-v17.1.txt` で検証できます。
...
**v17: 全国完成 — 九州・沖縄8県（福岡・佐賀・長崎・熊本・大分・宮崎・鹿児島・沖縄）を追加し、47都道府県すべてを収録しました。計78,515件、1,375市区町村（v17.1でギャップ補完841件を追加反映）。近畿・岡山のギャップ補完475件も反映（既存IDは全件不変）。**
...
| 山梨県 | `data/yamanashi.jsonl` | 1,419 | 21 / 27市町村（6町村は網羅一覧なし；笛吹市は初版後の回収で135件（公式の集計値は62件）；甲斐市は後継PDFを発見し公式76件と完全一致） |
| 富山県 | `data/toyama.jsonl` | 946 | 15 / 15市町村（全カバー；射水市108は市の現行オープンデータ準拠） |
| 石川県 | `data/ishikawa.jsonl` | 2,060 | 19 / 19市町（能登町はギャップ補完で32件回収（公式320件・完全な公開一覧は存在せず）；12市町が公式件数と完全一致） |
| 福井県 | `data/fukui.jsonl` | 1,507 | 17 / 17市町（全カバー；越前町113は織田文化歴史館、永平寺町21は町勢要覧より） |
| 長野県 | `data/nagano.jsonl` | 3,541 | 60 / 77市町村（17町村は網羅一覧なし；岡谷市121は教育要覧PDFより；高森町4/30） |
...
| 愛知県 | `data/aichi.jsonl` | 3,397 | 45 / 54市町村（8町村は網羅一覧なし；一宮市は県指定混入を除去し245件；瀬戸市はギャップ補完で55/55に到達・常滑市21/145は公式サイトが代表例のみ公開） |
| 三重県 | `data/mie.jsonl` | 1,698 | 24 / 29市町（5町は網羅一覧なし；桑名市110は2001年製画像マップDBのJS解析で全量回収；松阪市143は地区ページ由来で網羅性未認定） |
| 滋賀県 | `data/shiga.jsonl` | 1,536 | 18 / 19市町（完全一致12：長浜248・東近江206等；湖南市は公式66件だが個別名の公開一覧なし；竜王町は一覧非公開） |
| 京都府 | `data/kyoto.jsonl` | 1,177 | 16 / 26市町村（9町村は一覧非公開；京都市408は市DBの静的カテゴリリンクから回収；与謝野町は集計のみ） |
| 大阪府 | `data/osaka.jsonl` | 1,329 | 36 / 43市町村（7町村は市町村指定0件を府PDFで裏取り；八尾市はギャップ補完で外部マップサービスから69/73を回収） |
| 兵庫県 | `data/hyogo.jsonl` | 2,406 | 38 / 41市町（完全一致14：神戸125・豊岡251等；養父市・香美町は個別一覧に未到達；相生市・稲美町は一覧非公開） |
| 奈良県 | `data/nara.jsonl` | 742 | 34 / 39市町村（完全一致17；5町村は一覧非公開、4村町は指定区分ラベルなし） |
| 和歌山県 | `data/wakayama.jsonl` | 754 | 17 / 30市町（12町村は一覧非公開；和歌山市92完全一致；有田川町3/144；海南市はJS描画サイト） |
...
| 岡山県 | `data/okayama.jsonl` | 1,713 | 20 / 27市町村（完全一致11：倉敷86・真庭202等；津山市はSPAのみ・吉備中央町は集計のみ；久米南町は町指定制度なし） |
| 広島県 | `data/hiroshima.jsonl` | 1,943 | 21 / 23市町（広島市108（13本のPDFより）；熊野町はドメイン失効でWayback経由；府中町は現行町指定なしを確認） |
| 山口県 | `data/yamaguchi.jsonl` | 974 | 18 / 19市町（完全一致8：下関146・萩138等；周防大島町は公式28件だが個別一覧非公開） |
| 徳島県 | `data/tokushima.jsonl` | 670 | 17 / 24市町村（完全一致5；6町村は一覧非公開；東みよし町は原典に指定区分なし） |
| 香川県 | `data/kagawa.jsonl` | 799 | 15 / 17市町（さぬき市はTLS失効でWayback経由；三木町は区分確認不能；琴平町は一覧非公開） |
| 愛媛県 | `data/ehime.jsonl` | 1,989 | 20 / 20市町（新居浜76・内子95完全一致；西予市・松野町は集計のみ） |
| 高知県 | `data/kochi.jsonl` | 940 | 19 / 34市町村（完全一致4；13小規模町村は一覧非公開；土佐市はWAFで取得不能） |
| 福岡県 | `data/fukuoka.jsonl` | 1,227 | 45 / 60市町村（福岡市198は教育要覧PDFより（v17.1で重複20件を除去）；久留米107・宗像33完全一致；13町村は一覧非公開） |
| 佐賀県 | `data/saga.jsonl` | 455 | 14 / 20市町（唐津市110＝旧参照値52は県列の誤読；JS型・区分なしソースの自治体が複数） |
| 長崎県 | `data/nagasaki.jsonl` | 1,105 | 21 / 21市町（完全一致12：対馬123・壱岐168等；5町は一覧非公開） |
| 熊本県 | `data/kumamoto.jsonl` | 1,995 | 40 / 45市町村（完全一致25：八代197・山鹿160等；球磨郡の小規模村は集計のみ公開） |
| 大分県 | `data/oita.jsonl` | 2,148 | 18 / 18市町村（全カバー；佐伯220・宇佐209完全一致；国東322は71大字ページから収集） |
| 宮崎県 | `data/miyazaki.jsonl` | 631 | 20 / 26市町村（完全一致10；6町村は一覧非公開；延岡市は公式98件の一覧が存在せず5件） |
| 鹿児島県 | `data/kagoshima.jsonl` | 1,701 | 37 / 43市町村（完全一致22：鹿児島市91・南九州156等） |
| 沖縄県 | `data/okinawa.jsonl` | 859 | 31 / 41市町村（完全一致10：うるま46・名護50等；8町村は一覧非公開；多良間村32/70） |
| 合計 | `data/all.geojson` | **78,515** | 1,375 / 1,741市区町村 |

- **jmh_id**: 全行に `JMH-XXXXXX-NNNN` 形式の固有IDを付与。v17で九州沖縄8県とギャップ補完の計10,293件を追加、既存IDは全件引き継ぎ（変更0件）。全国完成。
