...
— 26,631 designations across 519 municipalities (14 prefectures). Tokyo adds the 区指定 (special-ward-designated) designation type.** The schema is designed to scale nationally
...
| **合計** | [`data/all.geojson`](data/all.geojson) | **26,631** | **519 / 605** |
...
- **26,631 designations total** across fourteen prefectures (Tohoku 6 + Hokkaido + Kanto complete).
...
```bash
python3 site/build_pages.py           # ~26,631 pages under site/p/
```
...
**v11: 東北6県＋北海道＋関東1都6県（栃木・群馬・茨城・埼玉・千葉・神奈川・東京）が対象です。計26,631件、519市区町村、14都道府県。関東完結。東京都は特別区の「区指定」区分を含みます。**
...
| 合計 | `data/all.geojson` | **26,631** | 519 / 605市区町村 |
