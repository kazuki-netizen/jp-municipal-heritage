...
soup = BeautifulSoup(open('/Users/miyazakihitohata/bunkazai/pipeline/cache/滋賀県/moriyama/page.html', encoding='utf-8', errors='ignore'), 'lxml')
...
print(len(out))
with open('/Users/miyazakihitohata/bunkazai/pipeline/out/滋賀県/moriyama.jsonl', 'w', encoding='utf-8') as f:
    for o in out:
