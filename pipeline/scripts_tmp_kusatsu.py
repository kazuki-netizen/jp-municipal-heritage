...
soup = BeautifulSoup(open('/Users/user/bunkazai/pipeline/cache/滋賀県/kusatsu/page.html', encoding='utf-8', errors='ignore'), 'lxml')
...
print(len(out))
with open('/Users/user/bunkazai/pipeline/out/滋賀県/kusatsu.jsonl', 'w', encoding='utf-8') as f:
    for o in out:
