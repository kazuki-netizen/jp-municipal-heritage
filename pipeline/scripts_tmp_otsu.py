...
wb = openpyxl.load_workbook('/Users/miyazakihitohata/bunkazai/pipeline/cache/滋賀県/otsu/data.xlsx', data_only=True)
ws = wb.active
...
print(len(out))
with open('/Users/miyazakihitohata/bunkazai/pipeline/out/滋賀県/otsu.jsonl', 'w', encoding='utf-8') as f:
    for o in out:
