...
with open('/Users/user/bunkazai/pipeline/cache/島根県/masuda/c541f3276a5477b5.html', encoding='utf-8', errors='replace') as f:
    html = f.read()
...
with open('/Users/user/bunkazai/pipeline/out/島根県/masuda.jsonl', 'w') as f:
    for r in results:
