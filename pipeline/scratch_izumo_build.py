...
with open('/Users/miyazakihitohata/bunkazai/pipeline/scratch_izumo_table7.json', encoding='utf-8') as f:
    data = json.load(f)
...
with open('/Users/miyazakihitohata/bunkazai/pipeline/out/島根県/izumo.jsonl', 'w') as f:
    for r in results:
