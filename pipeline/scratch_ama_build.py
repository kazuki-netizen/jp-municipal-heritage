...
with open('/Users/miyazakihitohata/bunkazai/pipeline/scratch_ama_table.json', encoding='utf-8') as f:
    data = json.load(f)
...
with open('/Users/miyazakihitohata/bunkazai/pipeline/out/島根県/ama.jsonl', 'w') as f:
    for r in results:
