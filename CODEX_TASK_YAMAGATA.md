# Task: Collect 市町村指定文化財 for YAMAGATA Prefecture (山形県)

Collect municipality-designated cultural properties for the 35 municipalities of 山形県, one part file per municipality, into `data/yamagata_parts/<romaji>.jsonl`.
...
```json
{"pref":"山形県","municipality":"山形市","name":"...","category":"有形文化財","subcategory":"彫刻","designation":"市指定","designated_date":"1966-10-18","location":"...","description":null,"source_url":"https://...","source_format":"html","fetched_at":"2026-07-03T20:00:00+09:00"}
```
...
- When all municipalities are done: merge all part files into `data/yamagata.jsonl`, validate, and write `notes/coverage-yamagata.md` — a per-municipality table (municipality | source URL | format | rows | missed estimate | difficulty | note) in the same style as `notes/coverage.md`, plus totals and 国/県 counts observed.
